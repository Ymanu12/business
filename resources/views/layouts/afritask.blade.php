...
<body class="h-full bg-stone-50 text-zinc-900 antialiased dark:bg-zinc-950 dark:text-zinc-100">
    <div class="relative min-h-full overflow-x-hidden bg-[radial-gradient(circle_at_top,_rgba(13,148,136,0.14),_transparent_35%),linear-gradient(180deg,_#fcfcf9_0%,_#f6f3ee_100%)] dark:bg-none dark:bg-zinc-950">
        ...
        <header class="sticky top-0 z-50 border-b border-white/60 bg-white/85 backdrop-blur-xl dark:border-white/10 dark:bg-zinc-900/90">
            <div class="mx-auto flex max-w-7xl items-center gap-4 px-4 py-3 sm:px-6 lg:px-8">
                ...
                <div class="hidden min-w-0 flex-1 lg:block">
                    <form action="{{ route('search') }}" method="GET" class="mx-auto max-w-2xl">
                        <label class="flex items-center gap-3 rounded-full border border-zinc-200 bg-white px-4 py-3 shadow-sm shadow-zinc-200/50 transition focus-within:border-teal-500 focus-within:ring-2 focus-within:ring-teal-100 dark:border-zinc-700 dark:bg-zinc-800 dark:shadow-none">
                ...
                <nav class="ml-auto flex items-center gap-2 sm:gap-3">
                    @auth
                        @if (auth()->user()->isClient())
                            <a
                                ...
                                class="hidden rounded-full px-3 py-2 text-sm font-medium text-zinc-600 transition hover:bg-white hover:text-teal-700 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-teal-400 sm:inline-flex"
                            >
                                Devenir freelance
                            </a>
                        @endif
                    ...
                    @else
                        <a href="{{ route('login') }}" class="rounded-full px-3 py-2 text-sm font-medium text-zinc-700 transition hover:bg-white hover:text-teal-700 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-teal-400">
                            Connexion
                        </a>
                        <a href="{{ route('register') }}" class="inline-flex items-center rounded-full bg-zinc-950 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-teal-700 dark:bg-teal-700 dark:hover:bg-teal-600">
                            S'inscrire
                        </a>
                    @endauth
                </nav>
